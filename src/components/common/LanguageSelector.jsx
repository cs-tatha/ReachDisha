  ...
  return (
    <div className={`relative inline-flex items-center shrink-0 ${className}`}>
      ...
      <div className="relative inline-flex items-center">
        ...
        <span
          className="pointer-events-none absolute left-2.5 sm:left-3 text-slate-600 flex items-center justify-center"
          aria-hidden="true"
        >
          <svg
        ...
        <select
          ...
          className="appearance-none bg-slate-50 hover:bg-slate-100 text-slate-800 hover:text-slate-950 border border-slate-300 hover:border-slate-400 rounded-full pl-7.5 pr-6.5 sm:pl-9 sm:pr-8 py-1 sm:py-2 h-9 sm:h-10 text-xs sm:text-sm font-bold cursor-pointer outline-none focus-visible:ring-2 focus-visible:ring-blue-600 focus-visible:border-transparent transition-all duration-150 shadow-2xs"
        >
        ...
        <span
          className="pointer-events-none absolute right-2 sm:right-3 text-slate-600 flex items-center justify-center"
          aria-hidden="true"
        >
          <svg
            className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-slate-600"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            strokeWidth="2.5"
